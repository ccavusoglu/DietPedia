package com.dietpedia.app.ui.behaviours;

import android.support.design.widget.CoordinatorLayout;
import android.support.v4.view.ViewCompat;
import android.support.v4.widget.ScrollerCompat;
import android.view.View;
import com.dietpedia.app.ui.widget.SlidingLayout;
...
public class SlidingBehavior extends CoordinatorLayout.Behavior<SlidingLayout> {
    ...
    @Override
    public boolean onMeasureChild(CoordinatorLayout parent, SlidingLayout child,
    ...
    public boolean onLayoutChild(CoordinatorLayout parent,
                                 SlidingLayout child, int layoutDirection) {
    ...
    public boolean onStartNestedScroll(CoordinatorLayout coordinatorLayout,
                                       SlidingLayout child, View directTargetChild,
    ...
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout,
                                  SlidingLayout child, View target,
                                  int dx, int dy,
                                  int[] consumed) {
    ...
    private void shiftSiblings(CoordinatorLayout parent, SlidingLayout child, int shift) {
        if (shift == 0) return;
    ...
    private boolean fling(CoordinatorLayout parent, SlidingLayout layout,
    ...
    private class FlingRunnable implements Runnable {
        ...
        private final SlidingLayout mLayout;

        FlingRunnable(CoordinatorLayout parent, SlidingLayout layout) {
            mParent = parent;
            mLayout = layout;
        }
    ...
    private SlidingLayout getPreviousChild(CoordinatorLayout parent, View child) {
    ...
    private SlidingLayout getNextChild(CoordinatorLayout parent, View child) {
        int cardIndex = parent.indexOfChild(child);
